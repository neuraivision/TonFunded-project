...
// One-phase evaluation. Rules mirror the standard prop-firm "1-Step" model:
// 45% profit target, 25% max drawdown, 10% daily drawdown, end-of-day (EOD)
// drawdown mode, 5 max open positions, 5 minimum trading days. Prices are the
// live promotional (discounted) prices.
