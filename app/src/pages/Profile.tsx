...
function MenuItem({
  ...
  return (
    <button
      onClick={onClick}
      className="w-full flex items-center gap-3 py-3.5 active:bg-gray-50 dark:active:bg-white/5 transition-colors rounded-xl px-1"
    >
  ...
  return (
    <div className="px-4 pt-4 pb-6 page-enter">
      ...
      <div className="grid grid-cols-3 gap-2 mb-5">
        <div className={`rounded-xl p-3 text-center border border-default ${profitPct >= 0 ? 'bg-green-50 dark:bg-green-900/20' : 'bg-red-50 dark:bg-red-900/20'}`}>
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-3 text-center border border-default">
          <p className="text-sm font-bold text-accent-app">{stats.winRate}%</p>
          <p className="text-[11px] text-tertiary">Win Rate</p>
        </div>
        <div className="bg-amber-50 dark:bg-amber-900/20 rounded-xl p-3 text-center border border-default">
          <div className="flex items-center justify-center gap-1 mb-0.5">
            <Flame size={12} className="text-amber-500" />
            <p className="text-sm font-bold text-amber-600">{stats.maxConsecutiveWins}</p>
          </div>
